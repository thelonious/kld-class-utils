...
exports.testObjectIsObject = function(beforeExit, assert) {
    var o = new Object();

    assert.equal(true, utils.isObject(o));
};

exports.testObjectLiteralIsObject = function(beforeExit, assert) {
    var o = {};

    assert.equal(true, utils.isObject(o));
};

exports.testArrayObject = function(beforeExit, assert) {
    var o = new Array();
